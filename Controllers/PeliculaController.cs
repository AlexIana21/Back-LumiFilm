...
namespace Reto_Back.Controllers
{
    ...
    public class PeliculaController : ControllerBase 
    {
        ...
        public static void InicializarDatos()
        {
            ...
            peliculas.Add(new Pelicula("Elevation", "Un padre soltero y dos mujeres se aventuran desde la seguridad de sus hogares a enfrentarse a criaturas monstruosas para salvar la vida de un niño.", 90, 16, "Acción", "George Nolfi", "../assets/images/pelis/elevation_ver2.webp"));
            ...
            peliculas.Add(new Pelicula("Emilia Pérez", "Sobrecualificada e infravalorada, Rita es una abogada de un gran bufete que un día recibe una oferta inesperada: ayudar al temido jefe de un cartel a retirarse de su negocio y desaparecer para siempre convirtiéndose en la mujer que él siempre ha soñado ser.", 130, 16, "Drama", "Jacques Audiard", "../assets/images/pelis/emilia_perez_ver4.webp"));
            peliculas.Add(new Pelicula("Robot Salvaje", "La robot Roz, que ha naufragado en una isla deshabitada, debe aprender a adaptarse al duro entorno, forjando poco a poco relaciones con la fauna local y convirtiéndose en madre adoptiva de una cría de ganso huérfana.", 102, 0, "Animación", "Chris Sanders", "../assets/images/pelis/robot.webp"));
            peliculas.Add(new Pelicula("Mienecraft", "Bienvenido al mundo de Minecraft, donde la creatividad no sólo ayuda a crear, sino que es esencial para la supervivencia. Cuatro inadaptados, se encuentran luchando con problemas ordinarios cuando de repente se ven arrastrados a través de un misterioso portal al Mundo Exterior: un extraño país de las maravillas cúbico que se nutre de la imaginación. Para volver a casa, tendrán que dominar este mundo.", 123, 0, "Fantástico", "Jared Hess", "../assets/images/pelis/minecraft.webp"));
