...
namespace Reto_Back.Controllers
{
    ...
    public class PeliculaController : ControllerBase 
    {
       ...
       [HttpGet("Titulo/{nombre}")]
        ...
        [HttpGet("MasVistas/")]
        public ActionResult<Pelicula> GetPeliculaMasVistas()
        {
            var pelicula = peliculas.Where(s => s.MasVistas == true);
            if (pelicula == null )
            {
                return NotFound();
            }
